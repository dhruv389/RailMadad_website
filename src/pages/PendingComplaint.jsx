      ...
      {products.map((product, index) => (
        <tr key={product.id} className="border-b" onClick={openDialog}>
          ...
          <td className="p-3 flex items-center gap-2">
            {/* {product.rating}{" "} */}
           <Link to="#" className="px-2 py-1 rounded-full text-white text-sm bg-red-500 ">Delete</Link>
           <Link to="#" className="bg-purple-700 text-sm px-2 py-1 rounded-full text-white ">Send</Link>
