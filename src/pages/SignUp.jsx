...
const SignUp = () => {
    ...
    return (
        ...
        //                     <input required type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" className="w-full p-3 rounded-lg focus:outline-none focus:ring focus:border-blue-300" />
        //                 </div>
        //                 <div className="mb-5">
        //                     <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-600">Password</label>
        //                     <input required type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" className="w-full p-3 rounded-lg focus:outline-none focus:ring focus:border-blue-300" />
        //                 </div>
        //                 <button type="submit" className="w-full bg-blue-500 py-3 rounded-lg text-white shadow-xl hover:bg-blue-700">Sign Up</button>
        //             </form>
        //         </div>
        //     </div>
        // </div>
